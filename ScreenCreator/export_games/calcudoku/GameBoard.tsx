...
export default function GameBoard({ size, ops, onWin, onBack }: GameBoardProps) {
    ...
    }, [puzzle, validateBoard, stopTimer, saveScore, onWin]);
        ...
        <div className="min-h-screen flex flex-col bg-white p-6 relative">
            ...
            <div className="flex gap-8 justify-center items-start min-h-[600px]">
                ...
                <div className="w-48 flex flex-col items-center gap-6 pt-4">
                    ...
                    <button
                        onClick={togglePause}
                        className="px-6 py-2 bg-blue-500 text-white rounded-full font-semibold hover:bg-blue-600 transition-all text-sm w-full"
                        title="Пауза"
                    >
