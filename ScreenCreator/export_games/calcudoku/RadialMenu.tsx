        ...
        <div className="absolute inset-0 z-50 flex items-center justify-center pointer-events-none">
            <div className="relative w-0 h-0 pointer-events-auto">
                ...
                {buttons.map((btn) => (
                    <button
                        key={btn.value}
                        className="absolute w-10 h-10 rounded-full bg-white border-2 border-blue-500 text-blue-700 font-bold flex items-center justify-center shadow-lg hover:scale-110 hover:bg-blue-50 transition-all z-10"
                        style={{
